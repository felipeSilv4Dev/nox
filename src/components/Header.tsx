...
const Header = () => {
  return (
    <header className="z-1 col-span-full flex h-fit w-full items-center justify-between">
      ...
      <nav>
        <ul className="*:md:text-x *:hover:text-white-100 *:text-white-700 space-x-4 *:font-[Assistant] *:font-semibold *:transition-all *:duration-200 *:xl:text-[18px] 2xl:space-x-6 *:2xl:text-xl">
